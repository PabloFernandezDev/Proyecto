 ...
 */
final class Version20250513165521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE administrador (id INT AUTO_INCREMENT NOT NULL, taller_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, num_emp INT NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_44F9A5216DC343EA (taller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE coche (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, marca_id INT DEFAULT NULL, modelo_id INT DEFAULT NULL, imagen VARCHAR(255) DEFAULT NULL, año INT DEFAULT NULL, INDEX IDX_A1981CD4DB38439E (usuario_id), INDEX IDX_A1981CD481EF0041 (marca_id), INDEX IDX_A1981CD4C3A9576E (modelo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE factura (id INT AUTO_INCREMENT NOT NULL, reparacion_id INT NOT NULL, numero VARCHAR(100) NOT NULL, fecha_emision DATETIME NOT NULL, subtotal DOUBLE PRECISION NOT NULL, iva DOUBLE PRECISION NOT NULL, total DOUBLE PRECISION NOT NULL, observaciones LONGTEXT DEFAULT NULL, INDEX IDX_F9EBA009AB0096FA (reparacion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mecanico (id INT AUTO_INCREMENT NOT NULL, administrador_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, num_emp INT NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_D2521E7A48DFEBB7 (administrador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reparaciones (id INT AUTO_INCREMENT NOT NULL, mecanico_id INT DEFAULT NULL, coche_id INT DEFAULT NULL, estado VARCHAR(200) NOT NULL, fecha_inicio DATE NOT NULL, fecha_fin DATE NOT NULL, INDEX IDX_60AF46E6E032763 (mecanico_id), INDEX IDX_60AF46EF4621E56 (coche_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE taller (id INT AUTO_INCREMENT NOT NULL, provincia_id INT DEFAULT NULL, direccion VARCHAR(200) NOT NULL, latitud DOUBLE PRECISION NOT NULL, longitud DOUBLE PRECISION NOT NULL, INDEX IDX_139F45844E7121AF (provincia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE factura ADD CONSTRAINT FK_F9EBA009AB0096FA FOREIGN KEY (reparacion_id) REFERENCES reparaciones (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE factura DROP FOREIGN KEY FK_F9EBA009AB0096FA');
