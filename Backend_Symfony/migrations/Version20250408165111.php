 ...
 */
final class Version20250408165111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coche (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, marca_id INT DEFAULT NULL, INDEX IDX_A1981CD4DB38439E (usuario_id), INDEX IDX_A1981CD481EF0041 (marca_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mecanico (id INT AUTO_INCREMENT NOT NULL, administrador_id INT DEFAULT NULL, INDEX IDX_D2521E7A48DFEBB7 (administrador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
